  ...
  const ratSet = [
    {
      ...
      description: "Плъховете могат да проникнат в сгради през малки отвори и пукнатини, често използвайки тръби и кабели като път за достъп.",
      icon: <IconWall size={50}/>,
    },
    {
      title: "Привличане към храна",
      description: "Плъховете имат много изострено обоняние и биват привлечени от всякакви хранителни източници, включително отпадъци, складирана храна и дори храната на домашни любимци.",
      icon: <IconApple size={50} />,
    },
    {
      title: "Разпространение на болести",
      description: "Плъховете са известни преносители на множество заболявания, включително лептоспироза, салмонела и хантавирус, представлявайки сериозна заплаха за здравето.",
      icon: <IconVirus size={50} />,
    },
    {
      title: "Структурни щети",
      description: "Плъховете могат да причинят значителни щети на сгради, като прегризват електрически кабели, изолация и дори водопроводни тръби.",
      icon: <IconAlertTriangle size={50} />,
    },
    {
        title: "Оглед на обекта",
        description: "Сертифициран експерт по дератизация прави оглед на обекта за установяване на наличието, вида и степента на заселване с плъхове",
        icon: <IconSearch size={50}/>,
      },
      {
        title: "Дератизация на обекта",
        description: "Нашите специалисти извършват дератизация на обекта, използвайки комбинация от методи, включително залагане на примамки, капани и блокиране на входни точки",
        icon: <RatIcon className="fill-neutral-600 dark:fill-neutral-400 group-hover:fill-ddblue dark:group-hover:fill-lgreen transition duration-200" />,
      },
      {
        title: "Издаване на протокол",
        description: "След извършване на дератизацията задължително издаваме протокол по образец на Министерство на здравеопазването, където са описани подробно приложените мерки за контрол на плъхове",
        icon: <IconScript size={50} />,
      },
      {
        title: "Проследяване на ефективността",
        description: "По желание на клиента можем да проследим ефективността на проведените мероприятия по дератизация с цел гарантиране успешния контрол на плъховете",

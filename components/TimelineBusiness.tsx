  ...
  const data = [
    {
        ...
        content: (
          <div>
            ...
            "Изготвяне на системи за самоконтрол",
      ...
      },
    {
    ...
    },
      {
        ...
        content: (
          <div>
            <p className="text-neutral-800 dark:text-neutral-200 font-russo text-base md:text-2xl font-normal mb-12">
            Ако вече имате сключен договор за ДДД, но не сте удовлетворени от услугата, свържете се с нас! Наш екип ще Ви посети, ще извърши оглед на поверения Ви обект и ще  изготви най-изгодната за Вас оферта!
            </p>
          </div>
        ),
      },
